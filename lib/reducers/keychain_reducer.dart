...
KeychainState _onHdWalletInitialization(
    KeychainState keychainState, InitializeHDWalletAction action,) {
...
KeychainState _onNetworksUpdated(
    KeychainState keychainState, UpdateNetworksWithAddressesAction action,) {
...
KeychainState _onAddAddresses(
    KeychainState keychainState, AddAddressAction action,) {
...
KeychainState _onCurrentNetworkUpdated(
    KeychainState keychainState, UpdateCurrentNetworkAction action,) {
  return keychainState.copyWith(
...
KeychainState _onBalancesUpdated(
    KeychainState keychainState, UpdateBalancesAction action,) {
  return keychainState.copyWith(
    networks: {
      ...keychainState.networks,
