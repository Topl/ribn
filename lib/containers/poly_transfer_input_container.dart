...
//     final num networkFee =
//         NetworkUtils.networkFees[store.state.keychainState.currentNetwork.networkId]!.getInNanopoly;
...
//           store.state.keychainState.currentNetwork.getPolysInWallet() - networkFee,
