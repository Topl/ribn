...
final $typed_data.Uint8List simpleValueDescriptor = $convert.base64Decode('CgtTaW1wbGVWYWx1ZRIaCghxdWFudGl0eRgBIAEoCVIIcXVhbnRpdHk=');
...
final $typed_data.Uint8List inputBoxDescriptor = $convert.base64Decode('CghJbnB1dEJveBIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEhQKBW5vbmNlGAIgASgJUgVub25jZQ==');
...
final $typed_data.Uint8List outputBoxDescriptor = $convert.base64Decode('CglPdXRwdXRCb3gSGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcxIvCgV2YWx1ZRgCIAEoCzIZLmNvLnRvcGwuZ2VudXMuVG9rZW5WYWx1ZVIFdmFsdWU=');
...
final $typed_data.Uint8List blockHeightDescriptor = $convert.base64Decode('CgtCbG9ja0hlaWdodBIUCgV2YWx1ZRgBIAEoBFIFdmFsdWU=');
