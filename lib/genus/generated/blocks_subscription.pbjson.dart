...
const BlocksSubscriptionRes$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.co.topl.genus.services.BlocksSubscriptionRes.Failure',
      '9': 0,
      '10': 'failure'
    },
  ],
...
final $typed_data.Uint8List blocksSubscriptionResDescriptor = $convert.base64Decode(
    '');
